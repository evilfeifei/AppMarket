...
public class AppAdapterOld extends BaseAdapter{

	private List<AppInfo> appBeans;
	private Context mContext;
	protected AsyncHttpClient ahc;

	public AppAdapterOld(Context context){
	...
	public AppAdapterOld(Context context, List<AppInfo> appBeans){
...
//									ToastUtil.toastshort(AppDettailsActivity2.this, error);
	...
	private class MyDownloadListener extends DownloadListener {
		...
		public void onProgress(DownloadInfo downloadInfo) {
			...
			AppAdapterOld.ViewHolder holder = (AppAdapterOld.ViewHolder) getUserTag();
