...
public class MyCollectActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    private void initView(){
        ...
        appAdapter = new AppAdapter(MyCollectActivity.this);
    ...
    public void getMyCollect(int pageNo){
        RequestParams rp = new RequestParams();
        rp.put("userId", userId);
        rp.put("token", token);
        rp.put("pageNo", pageNo);
        ahc.post(MyCollectActivity.this, Constant.MY_COLLECT_LIST, rp,
                new JsonHttpResponseHandler(Constant.UNICODE) {
                    ...
                    public void onSuccess(int statusCode, Header[] headers,
                        ...
                        if (statusCode == 200) {
                            ...
                            if (dataMap.get("error").toString().equals("")) {
                                ...
                                if (appAdapter == null) {
                                    appAdapter = new AppAdapter(MyCollectActivity.this, appBeans);
                                }
                    ...
                    public void onFailure(int statusCode, Header[] headers,
                        ...
                        super.onFailure(statusCode, headers, responseString,
                                throwable);
                        Toast.makeText(MyCollectActivity.this, "请检查网络!", Toast.LENGTH_LONG).show();
                    }
                });
    }
