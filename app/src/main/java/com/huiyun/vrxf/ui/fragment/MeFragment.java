...
import com.huiyun.vrxf.ui.LoginActivity;
import com.huiyun.vrxf.ui.MyCollectActivity;
import com.huiyun.vrxf.ui.MyPraiseActivity;
import com.huiyun.vrxf.ui.MyTrampleActivity;
import com.huiyun.vrxf.ui.SettingActivity;
import com.huiyun.vrxf.ui.UserSettingActivity;
...
//        view.findViewById(R.id.my_header_img).setOnClickListener(this);
        ...
        //add by popovich
        view.findViewById(R.id.user_shop_cart).setOnClickListener(this);
        view.findViewById(R.id.user_shop_order).setOnClickListener(this);
    }
...
//                break;
            ...
            case R.id.user_shop_cart://购物车
                if (userId.equals("")) {
                    loadNext(LoginActivity.class);
                } else {
                }
                break;
            case R.id.user_shop_order://商城订单
                if (userId.equals("")) {
                    loadNext(LoginActivity.class);
                } else {
                }
