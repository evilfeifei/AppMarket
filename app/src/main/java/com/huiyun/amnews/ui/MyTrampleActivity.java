 ...
 */
public class MyTrampleActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener,
        RefreshLayout.OnLoadListener {

    public static MyTrampleActivity myCollectActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_trample);
    ...
    private void initView(){
        ...
        appAdapter = new AppAdapter(MyTrampleActivity.this);
    ...
    public void getMyTrample(int pageNo){
        RequestParams rp = new RequestParams();
        rp.put("userId", userId);
        rp.put("token", token);
        rp.put("pageNo", pageNo);
        ahc.post(MyTrampleActivity.this, Constant.MY_TRAMPLE_LIST, rp,
                new JsonHttpResponseHandler(Constant.UNICODE) {
                    ...
                    public void onSuccess(int statusCode, Header[] headers,
                        ...
                        if (statusCode == 200) {
                            ...
                            if (dataMap.get("error").toString().equals("")) {
                                ...
                                if (appAdapter == null) {
                                    appAdapter = new AppAdapter(MyTrampleActivity.this, appBeans);
                                }
                    ...
                    public void onFailure(int statusCode, Header[] headers,
                        ...
                        super.onFailure(statusCode, headers, responseString,
                                throwable);
                        Toast.makeText(MyTrampleActivity.this, "请检查网络!", Toast.LENGTH_LONG).show();
                    }
                });
    }
