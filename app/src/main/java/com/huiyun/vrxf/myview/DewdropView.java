        ...
        switch(event.getActionMasked()){
            case MotionEvent.ACTION_DOWN:
                 ...
                 RelativeLayout.LayoutParams lParams = (RelativeLayout.LayoutParams) view
     					.getLayoutParams();
     			_xDelta = touchPX - lParams.leftMargin;
     			_yDelta = touchPY - lParams.topMargin;
            ...
            case MotionEvent.ACTION_UP:
                isDraging = false;
                 if(isInView()){
                    ...
                    if (movex-touchPX> 5 || movey-touchPY> 5) {
                    	reset();
        			} else {
//        				Toast.makeText(MainActivity.this, "点我", 1).show();
        			}
                    }
                break;
